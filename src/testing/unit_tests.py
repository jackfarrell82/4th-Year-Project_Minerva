...
class TestMinervaPrompts(unittest.TestCase):
    ...
    def test_SQL(self):
        self.assertEqual(minerva("What is SQL"), "Structure Query Language (SQL) is a programming language that is used to interact with and retrieve data from large relational databases, with my help you don't need to know any SQL, I can translate your query into SQL")
        self.assertEqual(minerva("Do I need to know SQL"), "Structure Query Language (SQL) is a programming language that is used to interact with and retrieve data from large relational databases, with my help you don't need to know any SQL, I can translate your query into SQL")
        self.assertEqual(minerva("Do you use SQL"), "Structure Query Language (SQL) is a programming language that is used to interact with and retrieve data from large relational databases, with my help you don't need to know any SQL, I can translate your query into SQL")
        self.assertEqual(minerva("How does SQL work"), "Structure Query Language (SQL) is a programming language that is used to interact with and retrieve data from large relational databases, with my help you don't need to know any SQL, I can translate your query into SQL")

    def test_Databases(self):
        self.assertEqual(minerva("What datasets are available"), "In my Beta version I have access to two databases: <br> The default database is a medical dataset that contains information on individuals with metabolic syndrome, you can view the <a href='https://www.kaggle.com/datasets/antimoni/metabolic-syndrome'>source here</a><br> You can also swap to our finance dataset, which is full of numbers that describe the daily index prices for different stock exchanges, you can view the <a href='https://www.kaggle.com/datasets/mattiuzc/stock-exchange-data'>source here</a>")
